...
<section class="section secPadding">
    <div class="container">
        ...
        <br>
        <div class="row no-view animated object-visible fadeIn" data-animation-effect="fadeIn">
            <div class="col-md-12">
                ...
                <div class="isotope-container row grid-space-20" style="position: relative; height: 1500px;">
