<div id="nzraineffects" class="rain">
    <#--
    ...
    <div class="front-row">
        ...
        <div class="drop" style="left: 1%; animation-delay: 0.21s; animation-duration: 0.521s;">
        ...
        <div class="drop" style="left: 5%; animation-delay: 0.21s; animation-duration: 0.521s;">
            <div class="stem" style="animation-delay: 0.21s; animation-duration: 0.521s;"></div>
            <div class="splat" style="animation-delay: 0.21s; animation-duration: 0.521s;"></div>
        </div>
        <div class="drop" style="left: 10%; animation-delay: 0.56s; animation-duration: 0.556s;">
        ...
        <div class="drop" style="left: 14%; animation-delay: 0.85s; animation-duration: 0.585s;">
        ...
        <div class="drop" style="left: 19%; animation-delay: 0.31s; animation-duration: 0.531s;">
        ...
        <div class="drop" style="left: 21%; animation-delay: 0.95s; animation-duration: 0.595s;">
        ...
        <div class="drop" style="left: 25%; animation-delay: 0.62s; animation-duration: 0.562s;">
        ...
        <div class="drop" style="left: 30%; animation-delay: 0.30s; animation-duration: 0.530s;">
        ...
        <div class="drop" style="left: 34%; animation-delay: 0.62s; animation-duration: 0.562s;">
            <div class="stem" style="animation-delay: 0.62s; animation-duration: 0.562s;"></div>
            <div class="splat" style="animation-delay: 0.62s; animation-duration: 0.562s;"></div>
        </div>
        <div class="drop" style="left: 39%; animation-delay: 0.19s; animation-duration: 0.519s;">
        ...
        <div class="drop" style="left: 43%; animation-delay: 0.96s; animation-duration: 0.596s;">
        ...
        <div class="drop" style="left: 48%; animation-delay: 0.93s; animation-duration: 0.593s;">
        ...
        <div class="drop" style="left: 50%; animation-delay: 0.79s; animation-duration: 0.579s;">
        ...
        <div class="drop" style="left: 54%; animation-delay: 0.67s; animation-duration: 0.567s;">
        ...
        <div class="drop" style="left: 59%; animation-delay: 0.96s; animation-duration: 0.596s;">
            <div class="stem" style="animation-delay: 0.96s; animation-duration: 0.596s;"></div>
            <div class="splat" style="animation-delay: 0.96s; animation-duration: 0.596s;"></div>
        </div>
        <div class="drop" style="left: 64%; animation-delay: 0.7s; animation-duration: 0.57s;">
        ...
        <div class="drop" style="left: 69%; animation-delay: 0.69s; animation-duration: 0.569s;">
        ...
        <div class="drop" style="left: 74%; animation-delay: 0.48s; animation-duration: 0.548s;">
        ...
        <div class="drop" style="left: 79%; animation-delay: 0.67s; animation-duration: 0.567s;">
            <div class="stem" style="animation-delay: 0.67s; animation-duration: 0.567s;"></div>
            <div class="splat" style="animation-delay: 0.67s; animation-duration: 0.567s;"></div>
        </div>
        <div class="drop" style="left: 82%; animation-delay: 0.2s; animation-duration: 0.52s;">
        ...
        <div class="drop" style="left: 87%; animation-delay: 0.44s; animation-duration: 0.544s;">
        ...
        <div class="drop" style="left: 90%; animation-delay: 0.71s; animation-duration: 0.571s;">
        ...
        <div class="drop" style="left: 93%; animation-delay: 0.72s; animation-duration: 0.572s;">
        ...
        <div class="drop" style="left: 95%; animation-delay: 0.59s; animation-duration: 0.559s;">
    ...
    <div class="back-row">
        ...
        <div class="drop" style="right: 1%; animation-delay: 0.21s; animation-duration: 0.521s;">
            <div class="stem" style="animation-delay: 0.21s; animation-duration: 0.521s;"></div>
            <div class="splat" style="animation-delay: 0.21s; animation-duration: 0.521s;"></div>
        </div>
        <div class="drop" style="right: 5%; animation-delay: 0.21s; animation-duration: 0.521s;">
            <div class="stem" style="animation-delay: 0.21s; animation-duration: 0.521s;"></div>
            <div class="splat" style="animation-delay: 0.21s; animation-duration: 0.521s;"></div>
        </div>
        <div class="drop" style="right: 10%; animation-delay: 0.56s; animation-duration: 0.556s;">
            <div class="stem" style="animation-delay: 0.56s; animation-duration: 0.556s;"></div>
            <div class="splat" style="animation-delay: 0.56s; animation-duration: 0.556s;"></div>
        </div>
        <div class="drop" style="right: 14%; animation-delay: 0.85s; animation-duration: 0.585s;">
            <div class="stem" style="animation-delay: 0.85s; animation-duration: 0.585s;"></div>
            <div class="splat" style="animation-delay: 0.85s; animation-duration: 0.585s;"></div>
        </div>
        <div class="drop" style="right: 19%; animation-delay: 0.31s; animation-duration: 0.531s;">
            <div class="stem" style="animation-delay: 0.31s; animation-duration: 0.531s;"></div>
            <div class="splat" style="animation-delay: 0.31s; animation-duration: 0.531s;"></div>
        </div>
        <div class="drop" style="right: 21%; animation-delay: 0.95s; animation-duration: 0.595s;">
            <div class="stem" style="animation-delay: 0.95s; animation-duration: 0.595s;"></div>
            <div class="splat" style="animation-delay: 0.95s; animation-duration: 0.595s;"></div>
        </div>
        <div class="drop" style="right: 25%; animation-delay: 0.62s; animation-duration: 0.562s;">
            <div class="stem" style="animation-delay: 0.62s; animation-duration: 0.562s;"></div>
            <div class="splat" style="animation-delay: 0.62s; animation-duration: 0.562s;"></div>
        </div>
        <div class="drop" style="right: 30%; animation-delay: 0.30s; animation-duration: 0.530s;">
            <div class="stem" style="animation-delay: 0.30s; animation-duration: 0.530s;"></div>
            <div class="splat" style="animation-delay: 0.30s; animation-duration: 0.530s;"></div>
        </div>
        <div class="drop" style="right: 34%; animation-delay: 0.62s; animation-duration: 0.562s;">
            <div class="stem" style="animation-delay: 0.62s; animation-duration: 0.562s;"></div>
            <div class="splat" style="animation-delay: 0.62s; animation-duration: 0.562s;"></div>
        </div>
        <div class="drop" style="right: 39%; animation-delay: 0.19s; animation-duration: 0.519s;">
            <div class="stem" style="animation-delay: 0.19s; animation-duration: 0.519s;"></div>
            <div class="splat" style="animation-delay: 0.19s; animation-duration: 0.519s;"></div>
        </div>
        <div class="drop" style="right: 43%; animation-delay: 0.96s; animation-duration: 0.596s;">
            <div class="stem" style="animation-delay: 0.96s; animation-duration: 0.596s;"></div>
            <div class="splat" style="animation-delay: 0.96s; animation-duration: 0.596s;"></div>
        </div>
        <div class="drop" style="right: 48%; animation-delay: 0.93s; animation-duration: 0.593s;">
            <div class="stem" style="animation-delay: 0.93s; animation-duration: 0.593s;"></div>
            <div class="splat" style="animation-delay: 0.93s; animation-duration: 0.593s;"></div>
        </div>
        <div class="drop" style="right: 50%; animation-delay: 0.79s; animation-duration: 0.579s;">
            <div class="stem" style="animation-delay: 0.79s; animation-duration: 0.579s;"></div>
            <div class="splat" style="animation-delay: 0.79s; animation-duration: 0.579s;"></div>
        </div>
        <div class="drop" style="right: 54%; animation-delay: 0.67s; animation-duration: 0.567s;">
            <div class="stem" style="animation-delay: 0.67s; animation-duration: 0.567s;"></div>
            <div class="splat" style="animation-delay: 0.67s; animation-duration: 0.567s;"></div>
        </div>
        <div class="drop" style="right: 59%; animation-delay: 0.96s; animation-duration: 0.596s;">
            <div class="stem" style="animation-delay: 0.96s; animation-duration: 0.596s;"></div>
            <div class="splat" style="animation-delay: 0.96s; animation-duration: 0.596s;"></div>
        </div>
        <div class="drop" style="right: 64%; animation-delay: 0.7s; animation-duration: 0.57s;">
            <div class="stem" style="animation-delay: 0.7s; animation-duration: 0.57s;"></div>
            <div class="splat" style="animation-delay: 0.7s; animation-duration: 0.57s;"></div>
        </div>
        <div class="drop" style="right: 69%; animation-delay: 0.69s; animation-duration: 0.569s;">
            <div class="stem" style="animation-delay: 0.69s; animation-duration: 0.569s;"></div>
            <div class="splat" style="animation-delay: 0.69s; animation-duration: 0.569s;"></div>
        </div>
        <div class="drop" style="right: 74%; animation-delay: 0.48s; animation-duration: 0.548s;">
            <div class="stem" style="animation-delay: 0.48s; animation-duration: 0.548s;"></div>
            <div class="splat" style="animation-delay: 0.48s; animation-duration: 0.548s;"></div>
        </div>
        <div class="drop" style="right: 79%; animation-delay: 0.67s; animation-duration: 0.567s;">
            <div class="stem" style="animation-delay: 0.67s; animation-duration: 0.567s;"></div>
            <div class="splat" style="animation-delay: 0.67s; animation-duration: 0.567s;"></div>
        </div>
        <div class="drop" style="right: 82%; animation-delay: 0.2s; animation-duration: 0.52s;">
            <div class="stem" style="animation-delay: 0.2s; animation-duration: 0.52s;"></div>
            <div class="splat" style="animation-delay: 0.2s; animation-duration: 0.52s;"></div>
        </div>
        <div class="drop" style="right: 87%; animation-delay: 0.44s; animation-duration: 0.544s;">
            <div class="stem" style="animation-delay: 0.44s; animation-duration: 0.544s;"></div>
            <div class="splat" style="animation-delay: 0.44s; animation-duration: 0.544s;"></div>
        </div>
        <div class="drop" style="right: 90%; animation-delay: 0.71s; animation-duration: 0.571s;">
            <div class="stem" style="animation-delay: 0.71s; animation-duration: 0.571s;"></div>
            <div class="splat" style="animation-delay: 0.71s; animation-duration: 0.571s;"></div>
        </div>
        <div class="drop" style="right: 93%; animation-delay: 0.72s; animation-duration: 0.572s;">
            <div class="stem" style="animation-delay: 0.72s; animation-duration: 0.572s;"></div>
            <div class="splat" style="animation-delay: 0.72s; animation-duration: 0.572s;"></div>
        </div>
        <div class="drop" style="right: 95%; animation-delay: 0.59s; animation-duration: 0.559s;">
            <div class="stem" style="animation-delay: 0.59s; animation-duration: 0.559s;"></div>
            <div class="splat" style="animation-delay: 0.59s; animation-duration: 0.559s;"></div>
        </div>
    </div>
    ...
    <script>
        let makeItRain = function () {
            let increment = 0, randoHundo, randoFiver, drops = "", backDrops = "", $rain = $('.rain'), $front = $('.rain .front-row'), $back = $('.rain .back-row');
            while (increment < 100) {
                ...
                randoFiver = (Math.floor(Math.random() * (5 - 2 + 1) + 1));
                //increment
